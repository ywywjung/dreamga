...
$page_nav["member"]["sub"]["customer-list"]["active"] = true;
include ("../../inc/nav.php");
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
            ...
            <form class="form-inline" role="form">
               <fieldset>
                     ...
                     <select name="s_mach_cd" class="smart-form form-control input-sm">
                        <option value="all01">서비스 전체</option>
                        <option value="all01_01" >산후조리</option>
                        <option value="all01_02" >베이비시터</option>
                        <option value="all01_03" >출장반찬</option>
                        <option value="all01_04" >기타</option>
                       </select>
                  </div>
                  <div class="form-group" id="div_mach_cd">
                     <select name="s_mach_cd" class="smart-form form-control input-sm">
                        <option value="all02">상태 전체</option>
                        <option value="all02_01" >입사</option>
                        <option value="all02_02" >퇴사</option>
                       </select>
                  </div>
                  ...
                  <button type="submit" class="btn btn-primary btn-sm">
                     <i class="glyphicon glyphicon-search"></i> 검색
                        ...
                        <div class="form-group" id="div_mach_cd">
                            <i class="fa fa-chevron-right padding-5"></i><span>고객수 :&nbsp;200명</span>
                        </div>
                        <button type="button" class="btn btn-danger btn-sm pull-right" id="customerRegBtn" data-toggle="modal" data-target="#customerRegModal" data-mode="888" data-title="고객정보 등록" data-code="855">
                              ...
                              <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                                 ...
                                 ?>
                                                <tr>
                                                    ...
                                                    <td><span class="label label-yellow">&nbsp;&nbsp;바우처&nbsp;&nbsp;</span></td>
                                                    <td>오순자</td>
                                                    <td>2000.11.05</td>
                                                    <td>010.5500.3239</td>
                                                    ...
                                                    <td>관리사1</td>
                                                    <td>입사</td>
                                                    <td><a class="btn btn-primary btn-xs" href="javascript:void(0);"><span class="customerModiBtn" data-title="고객정보 수정" data-mode="edit" data-code="" data-toggle="modal" data-target="#customerRegModal">수정</span></a></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>대전</td>
...
<!-- MODAL 등록/수정 -->
<div class="modal fade" id="customerRegModal" tabindex="-1" role="dialog" aria-labelledby="customerRegModalLabel" aria-hidden="true">
...
var runMain = {
    ...
    bind : function(){
        // 회원정보 등록신청
        $("body").on("click","#customerRegBtn,.customerModiBtn",function(e){
            ...
            runMain.fn.customerRegIssue(modalObjName,modalTitle,mode,code);
        });
        
        //달력
        $("body").on("click", "#startDate, #finishDate, #birthDate", function(e) {
            //console.log('달력');
    ...
    fn : {
        // 회원정보 등록/수정
        customerRegIssue : function(modalObjName, modalTitle, mode, code) {
            var ajaxUrl="/ajax/member/ajax-customer-reg.php";
