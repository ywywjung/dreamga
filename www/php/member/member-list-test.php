									...
									<div class="widget-body no-padding">
										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
											...
											<tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td><a class="btn btn-danger btn-xs" href="javascript:void(0);">관리자</a></td>
                                                    <td>aaa</td>
                                                    <td>오순자</td>
                                                    <td>2000.10.04</td>
                                                    <td>031.5500.3239</td>
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td><a class="btn btn-default btn-xs" href="javascript:void(0);">&nbsp;&nbsp;일반&nbsp;&nbsp;</a></td>
                                                    <td>aaa</td>
                                                    <td>오순자</td>
                                                    <td>2000.10.04</td>
                                                    <td>031.5500.3239</td>
                                                ...
                                                <tr>
                                                    <td>3</td>
                                                    <td><a class="btn btn-primary btn-xs" href="javascript:void(0);">&nbsp;&nbsp;직원&nbsp;&nbsp;</a></td>
                                                    <td>aaa</td>
                                                    <td>오순자</td>
                                                    <td>2000.10.04</td>
                                                    <td>031.5500.3239</td>
                                                ...
                                                <tr>
                                                    <td>4</td>
                                                    <td><a class="btn btn-success btn-xs" href="javascript:void(0);">지사장</a></td>
                                                    <td>aaa</td>
                                                    <td>오순자</td>
                                                    <td>2000.10.04</td>
                                                    <td>031.5500.3239</td>
        ...
        fn : {
            // 회원정보 등록/수정
			 memberRegIssue : function(modalObjName, modalTitle, mode, code){
                var ajaxUrl="/ajax/member/ajax-member-reg-test.php";
