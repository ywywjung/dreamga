                                ...
                                <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);"><span class="freelancerBtn" data-title="관리사정보보기" data-mode="edit" data-code="" data-toggle="modal" data-target="#freelancerModal">관리사</span></a></td>
                                            <td><a href="javascript:void(0);"><span class="customBtn" data-title="고객정보보기" data-mode="edit" data-code="" data-toggle="modal" data-target="#customerModal">황혜미 외 1건</span></a></td>
                                            <td>2000.11.05</td>
                                            <td>2000.11.05</td>
                                            <td>850,000</td>
...
<!-- modal 관리사정보보기 -->
<div class="modal fade" id="freelancerModal" tabindex="-1" role="dialog" aria-labelledby="freelancerModalLabel" aria-hidden="true">
