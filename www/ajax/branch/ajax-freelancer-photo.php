<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header" >
            ...
            <h4 class="modal-title" id="freelancerRegModalLabel">관리사사진</h4>
        </div>
                    ...
                    <form action="php/demo-register.php" id="smart-form-register" class="smart-form">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-4 control-label">이미지파일</label>
                                <div class="col-md-8">
                                    <input type="file" class="fileBtn btn btn-default" id="exampleInputFile1">
                                    <p class="help-block">* 사이즈는 150x150pixel권장 (형식:jpg,png,gif)</p>
                                </div>
                            </div>
                        </fieldset>
                    </form>
